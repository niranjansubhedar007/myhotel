...
const TasteList = () => {
  ...
  useEffect(() => {
    const fetchTastes = async () => {
      try {
        const response = await axios.get('http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/taste/tastes');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/taste/tastes/${selectedTaste._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      ...
      await axios.delete(`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/taste/tastes/${selectedTaste._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/taste/tastes', { taste: newTaste });
