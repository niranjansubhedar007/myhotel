...
//         try {
//             const response = await axios.get(`http://172.188.99.139:5000/api/table/tables/${tableId}`);
...
//                 `http://172.188.99.139:5000/api/table/${sectionId}/tables`,
//                 { numberOfTables },
//                 {
//                     headers: {
...
//         const fetchtables = async () => {
//             try {
//                 const response = await axios.get('http://172.188.99.139:5000/api/table/tables');
...
//                 `http://172.188.99.139:5000/api/table/tables/${tableToDelete._id}`
//             );
...
//                 `http://172.188.99.139:5000/api/table/tables/${editTable._id}`,
//                 formData,
//                 {
//                     headers: {
//                         'Content-Type': 'application/json',
...
//   //     const response = await axios.post(`http://172.188.99.139:5000/api/table/${sectionId}/tables`, JSON.stringify(checkedinputvalue));
...
const Tables = () => {
  ...
  const confirmAllDelete = async () => {
    try {
      ...
      const response = await axios.delete(`http://172.188.99.139:5000/api/table/tables`, {
