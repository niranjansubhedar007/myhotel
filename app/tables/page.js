...
//         try {
//             const response = await axios.get(`https://172.188.99.139:5001/api/table/tables/${tableId}`);
...
//             try {
//                 const tablesResponse = await axios.get('https://172.188.99.139:5001/api/table/tables');
...
//             try {
//                 const sectionsResponse = await axios.get('https://172.188.99.139:5001/api/section');
...
//                 `https://172.188.99.139:5001/api/table/${sectionId}/tables`,
//                 { numberOfTables },
//                 {
//                     headers: {
...
//         const fetchtables = async () => {
//             try {
//                 const response = await axios.get('https://172.188.99.139:5001/api/table/tables');
...
//                 `https://172.188.99.139:5001/api/table/tables/${tableToDelete._id}`
//             );
...
//                 `https://172.188.99.139:5001/api/table/tables/${editTable._id}`,
//                 formData,
//                 {
//                     headers: {
//                         'Content-Type': 'application/json',
...
//         `https://172.188.99.139:5001/api/table/tables/${tableId}`
//       );
//       const tableData = response.data;
...
//   //     const response = await axios.post(`https://172.188.99.139:5001/api/table/${sectionId}/tables`, JSON.stringify(checkedinputvalue));
...
const Tables = () => {
  ...
  const confirmAllDelete = async () => {
    try {
      ...
      const response = await axios.delete(`https://172.188.99.139:5001/api/table/tables`, {
