...
const BarGroupMenu = () => {
  ...
  const handleAddMenusToCategory = async () => {
    try {
      ...
      const response = await axios.post(
        `https://172.188.99.139:5001/api/liquorBrand/${selectedMainCategory}/assignmenus`,
        {
    ...
    const fetchData = async () => {
      try {
        ...
        const mainCategoriesResponse = await axios.get(
          "https://172.188.99.139:5001/api/liquorCategory/barMenus"
        );
  ...
  const fetchMenusForCategory = async () => {
    try {
      const response = await axios.get(
        `https://172.188.99.139:5001/api/liquorCategory/barMenus/${selectedMainCategory}`
      );
  ...
  const handleDeleteMenus = async () => {
    try {
      ...
      const response = await axios.delete(
        `https://172.188.99.139:5001/api/liquorBrand/${selectedMainCategory}/removemenus`,
        {
