...
const VatModal = ({ isOpen, onClose }) => {
    ...
    const handleConfirmDelete = async () => {
        try {
            ...
            await axios.delete(`https://172.188.99.139:5001/api/purchaseVAT/vat/${deletingItemId}`);
    ...
    const fetchVatList = async () => {
        try {
            const response = await axios.get('https://172.188.99.139:5001/api/purchaseVAT/vat');
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            await axios.post('https://172.188.99.139:5001/api/purchaseVAT/vat', { vatPercentage });
            fetchVatList();
            setVatPercentage('');
        } catch (error) {
...
const BarPurchaseForm = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get(
                    "https://172.188.99.139:5001/api/liquorBrand/barSubmenu/all"
                );
    ...
    useEffect(() => {
        const fetchChildMenuNames = async () => {
            try {
                const response = await axios.get(
                    `https://172.188.99.139:5001/api/liquorBrand/childmenus/list`
                );
    ...
    useEffect(() => {
        const fetchStockQty = async () => {
            try {
                const response = await axios.get(
                    `https://172.188.99.139:5001/api/barPurchase/purchase/childMenuStockQty?name=${formData.name}`
                );
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await axios.post(
                "https://172.188.99.139:5001/api/barPurchase/bar/purchase/savebill",
                data
            );
