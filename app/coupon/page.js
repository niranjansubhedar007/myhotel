    ...
    const fetchHotelInfo = async () => {
      try {
        ...
        const allHotelsResponse = await axios.get(
          "https://172.188.99.139:5001/api/counterHotel/get-all"
        );
        ...
        if (defaultHotelId) {
          ...
          const response = await axios.get(
            `https://172.188.99.139:5001/api/counterHotel/getHotel/${defaultHotelId}`
          );
  ...
  const handlePrintBillLan = async () => {
    try {
      const [couponResponse, counterResponse] = await Promise.all([
        axios.get("https://172.188.99.139:5001/api/coupon/coupon/latest"),
        axios.get("https://172.188.99.139:5001/api/counter"),
      ]);
...
`;
      ...
      await axios.post("http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/print-bill", {
        billContent
      });
  ...
  //       `https://172.188.99.139:5001/api/counterHotel/getHotel/661e0d39092937c54273c154`
  ...
  //       "https://172.188.99.139:5001/api/coupon/billCouponOrder",
  //       saveData
  //     );
  ...
  //       `https://172.188.99.139:5001/api/coupon/orderNumber/${orderNumber}`
  //     );
  ...
  useEffect(() => {
    axios
      .get("https://172.188.99.139:5001/api/counter")
      .then((response) => {
    ...
    axios
      .get("https://172.188.99.139:5001/api/table/tables")
      .then((response) => {
  ...
  useEffect(() => {
    if (selectedCategory) {
      axios
        .get(`https://172.188.99.139:5001/api/counter/${selectedCategory._id}`)
        .then((response) => {
  ...
  const printCouponLan = async () => {
    try {
      ...
      const countersResponse = await axios.get("https://172.188.99.139:5001/api/counter");
      const counters = countersResponse.data;
  
      // Fetch the latest coupon record from the API based on CouponDate
      const latestCouponResponse = await axios.get("https://172.188.99.139:5001/api/coupon/coupon/latest");
      ...
      const kotResponse = await axios.post("http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/print-coupon", {
  ...
  const printCoupon = async () => {
    try {
      ...
      const countersResponse = await axios.get(
        "https://172.188.99.139:5001/api/counter"
      );
      ...
      const latestCouponResponse = await axios.get(
        "https://172.188.99.139:5001/api/coupon/coupon/latest"
      );
