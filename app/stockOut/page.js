...
const NewItemModal = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    ...
    const fetchUnits = async () => {
      try {
        const unitsResponse = await axios.get("http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/unit/units");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      response = await axios.post("http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/item/items", {
        ...formData,
        unit: formData.unit || "",
...
const StockOutwardForm = () => {
  ...
  const handleAddItems = async () => {
    try {
      ...
      await axios.post("http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/stockOut/stockOut/addItems", {
        waiterName,
        productName,
        stockQty,
        availableQuantity,
      ...
      await axios.post("http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/item/items/updateQuantity", {
        productName,
        stockQty,
      });
    ...
    try {
      if (name === "waiterName") {
        ...
        const response = await axios.get(
          `http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/waiter/waiter/mobile?name=${value}`
        );
        setMobileNumber(response.data.mobileNumber);
      } else if (name === "productName") {
        setProductName(value);
        const response = await axios.get(
          `http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/item/items/quantity?productName=${value}`
        );
  ...
  const fetchStockOutwardList = async () => {
    try {
      const response = await axios.get(
        "http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/stockOut/stockOut"
      );
