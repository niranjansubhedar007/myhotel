...
const NewEditModal = ({ isOpen, onClose, onMenuUpdate }) => {
  ...
  useEffect(() => {
    if (selectedLiquorBrand) {
      axios
        .get(`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/getMenu/${selectedLiquorBrand}`)
        .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/barSubmenu/${selectedLiquorBrand}`,
        formData
      );
...
const BarList = () => {
  ...
  const confirmDelete = async () => {
    try {
      ...
      const response = await axios.delete(
        `http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/barSubmenu/${menuToDelete._id}`
      );
  ...
  const addNewMenu = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/barSubmenu",
        formData
      );
  ...
  useEffect(() => {
    ...
    axios
      .get('http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/barCategory/list')
      .then((response) => {
  ...
  const handleFileUpload = async () => {
    try {
      ...
      const response = await axios.post(
        "http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/upload-excel",
        formData
      );
      ...
      const stock = await axios.post('http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/updateStock');
      console.log(stock)
