...
const EditOrderPage = ({ params, tableId }) => {
      ...
      try {
        if (orderNumber) {
          ...
          const orderResponse = await axios.get(
            `https://172.188.99.139:5001/api/order/get/order/${orderNumber}`
          );
          ...
          const sectionResponse = await axios.get(
            `https://172.188.99.139:5001/api/section/sectionlist/${tableId}`
          );
  ...
  const handleSaveBill = async () => {
    try {
      ...
      await axios.post(`https://172.188.99.139:5001/api/logHistory/log-history`, {
      ...
      if (itemsForStockIn.length > 0) {
        ...
        await axios.post(
          "https://172.188.99.139:5001/api/liquorBrand/liquorBrand/stockIn",
          {
      ...
      const updateOrderEndpoint = `https://172.188.99.139:5001/api/order/update-order-by-number/${orderNumber}`;
...
`;
  ...
  ${index.message}`;}).join("")}---------------------------------------------
   ...
   await axios.patch(`https://172.188.99.139:5001/api/order/update-order-by-id/${orderIdToUpdate}`, {
  ...
  useEffect(() => {
    axios
      .get("https://172.188.99.139:5001/api/main")
      .then((response) => {
        console.log(response.data);
