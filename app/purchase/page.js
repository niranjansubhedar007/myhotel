...
//       await axios.delete(
//         `https://172.188.99.139:5001/api/item/items/${itemIdToDelete}`
//       );
...
//         "https://172.188.99.139:5001/api/item/items"
//       );
//       setItems(itemsResponse.data);

//       // Fetch the list of units
//       const unitsResponse = await axios.get(
//         "https://172.188.99.139:5001/api/unit/units"
//       );
...
//         await axios.post("https://172.188.99.139:5001/api/item/items", {
//           ...formData,
//           unit: formData.unit || "",
...
//       await axios.patch(
//         `https://172.188.99.139:5001/api/unit/units/${selectedUnit._id}`,
//         {
...
//       await axios.post("https://172.188.99.139:5001/api/unit/units", {
//         unit: newUnit,
//       });

//       // Fetch the updated list of units
//       const response = await axios.get("https://172.188.99.139:5001/api/unit/units");
//       setUnits(response.data);
...
//       await axios.delete(`https://172.188.99.139:5001/api/gst/gst/${deletingItemId}`);
...
//     try {
//       const response = await axios.get('https://172.188.99.139:5001/api/gst/list');
...
//     try {
//       await axios.post('https://172.188.99.139:5001/api/gst/create', { gstPercentage });
//       fetchGSTList();
//       setGSTPercentage('');
//     } catch (error) {
...
//         "https://172.188.99.139:5001/api/supplier/suppliers",
//         formData
//       );
...
//     //     `https://172.188.99.139:5001/api/supplier/suppliers/${editedSupplier._id}`,
//     //     editedSupplier
//     //   );
...
//       try {
//         const response = await axios.get(
//           `https://172.188.99.139:5001/api/purchase/purchase/stockQty?itemName=${formData.itemName}`
//         );
...
//       const response = await axios.post(
//         "https://172.188.99.139:5001/api/purchase/purchase/savebill",
//         data
//       );
...
//         await axios.post("https://172.188.99.139:5001/api/supplier/supplier/debit", {
//           vendorName,
//           amount: parseFloat(data.paidAmount),
//         });
//       } else {
//         // If there is no paid amount, update the supplier's credit balance
//         await axios.post("https://172.188.99.139:5001/api/supplier/supplier/credit", {
//           vendorName,
