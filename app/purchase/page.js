...
//       await axios.delete(
//         `http://172.188.99.139:5000/api/item/items/${itemIdToDelete}`
//       );
...
//         "http://172.188.99.139:5000/api/item/items"
//       );
...
//         await axios.post("http://172.188.99.139:5000/api/item/items", {
//           ...formData,
//           unit: formData.unit || "",
...
//       try {
//         const response = await axios.get(
//           `http://172.188.99.139:5000/api/purchase/purchase/stockQty?itemName=${formData.itemName}`
//         );
...
//       const response = await axios.post(
//         "http://172.188.99.139:5000/api/purchase/purchase/savebill",
//         data
//       );
