...
//         `https://172.188.99.139:5001/api/main/${mainCategory._id}`
//       );
...
//         "https://172.188.99.139:5001/api/main",
//         formData,
//         {
//           headers: {
...
//         `https://172.188.99.139:5001/api/main/${menu._id}`
//       );
...
//         `https://172.188.99.139:5001/api/main/${editedMenu._id}`,
//         formData,
//         {
//           headers: {
//             "Content-Type": "multipart/form-data",
...
//       const updatedMenusResponse = await axios.get("https://172.188.99.139:5001/api/main");
...
//     const completeImageUrl = `http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/${mainImage}`;
...
//       try {
//         const response = await axios.get("https://172.188.99.139:5001/api/main");
...
//                     <img
//                       src={`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/${mainCategoryToView.mainImage}`}
//                       alt="Main Category"
