...
const BarPurchaseReport = () => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    `https://172.188.99.139:5001/api/barPurchase/barpurchase/all?startDate=${startDate}&endDate=${endDate}`
                );
    ...
    useEffect(() => {
        const fetchVendors = async () => {
            try {
                const response = await axios.get("https://172.188.99.139:5001/api/supplier/suppliers");
    ...
    const handleSearch = async () => {
        try {
            const response = await axios.get("https://172.188.99.139:5001/api/barPurchase/barpurchase/all", {
                params: {
                    startDate,
                    endDate,
