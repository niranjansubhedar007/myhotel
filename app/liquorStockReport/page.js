...
//     try {
//       const res = await fetch(`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/order/stockQty/updateClosing`);
//       const data = await res.json();
//       console.log(data)
//       setClosingData(data);
//     } catch (error) {
...
//     try {
//       const res = await fetch(`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/order/closeStockQty/barmenus`);
//       const data = await res.json();
//       console.log(data)
...
//   useEffect(() => {
//     if (selectedDate) {
//       fetchData(`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/stockQty/barmenus?date=${selectedDate}`, setMenuData);
//       fetchData(`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/stockQty/barmenu?date=${selectedDate}`, setPurchaseMenuData);
//       fetchData(`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/order/stockQty/sellQty?date=${selectedDate}`, setSellMenuData);
//       fetchData(`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/order/closeStockQty/barmenus?date=${selectedDate}`, setClosingStockData);
//     }
//   }, [selectedDate]);

//   useEffect(() => {
//     fetchData(`http://ec2-16-171-154-162.eu-north-1.compute.amazonaws.com:5000/api/liquorBrand/order/stockQty/updateClosing`, setClosingData);
//   }, []);
